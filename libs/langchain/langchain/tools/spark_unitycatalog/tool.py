...
from langchain.tools.spark_unitycatalog.prompt import SQL_QUERY_VALIDATOR, SQL_QUERY_CREATOR
...
"""
    ...
    def _run(
        ...
        if hasattr(self, "state"):
            ...
            return "This tool is not meant to be run directly. Start with ListUnityCatalogTablesTool" 
